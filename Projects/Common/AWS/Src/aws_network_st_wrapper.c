...
#include <stdbool.h>
#include <string.h>
#include <aws_timer_platform.h>
#include <network_interface.h>
#include "aws_iot_error.h"
#include "aws_iot_log.h"
#include "aws_network_platform.h"
#include "heap.h"
...
IoT_Error_t iot_tls_connect(Network *pNetwork, TLSConnectParams *params)
{
  ...
  if((ret = net_sock_open(tlsDataParams->server_fd.fd, pNetwork->tlsConnectParams.pDestinationURL, pNetwork->tlsConnectParams.DestinationPort)) != NET_OK)
  {
